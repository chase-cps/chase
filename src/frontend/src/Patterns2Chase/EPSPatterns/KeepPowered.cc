 ...
 *
 * @file	frontend/src/Patterns2Chase/EPSPatterns/KeepPowered.cc
 * @brief
 */
...
std::vector< std::string > KeepPowered::_extractFormulae( std::string text )
{
    std::vector< std::string > ret;
    std::string pattern(" must never be unpowered from ");
...
std::vector< WellFormedFormula * > KeepPowered::_createPathFormulae(  
...
void KeepPowered::_createConstraints(
