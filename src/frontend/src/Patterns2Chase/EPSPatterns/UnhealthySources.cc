 ...
 *
 * @file	frontend/src/Patterns2Chase/EPSPatterns/UnhealthySources.cc
 * @brief
 */
...
// UNHEALTHY SOURCES
std::vector< std::string > UnhealthySources::_extractFormulae( std::string text )
{
    std::vector< std::string > ret;
    std::string pattern(" must be disconnected when unhealthy");
...
std::vector< WellFormedFormula * > UnhealthySources::_createPathFormulae(  
...
void UnhealthySources::_createConstraints(
