...
node_1_F1_outp = Real('node_1_F1_outp')
node_1_F2_outp = Real('node_1_F2_outp')
node_1_F3_outp = Real('node_1_F2_outp')
node_1_F0_outp = Real('node_1_F0_outp')

node_1_F1_inp = Real('node_1_F1_inp')
node_1_F2_inp = Real('node_1_F2_inp')
node_1_F3_inp = Real('node_1_F2_inp')
node_1_F0_inp = Real('node_1_F0_inp')

# ASSUMPTIONS AND GUARANTEES OF C1
##
node_1_assumptions = And(
    node_1_F1_in1 + node_1_F2_in1 + node_1_F3_in1 + node_1_F0_in1 <= 1,
    node_1_F1_in1 + node_1_F2_in1 + node_1_F3_in1 + node_1_F0_in1 >= 0,
    node_1_F1_in2 + node_1_F2_in2 + node_1_F3_in2 + node_1_F0_in2 <= 1,
    node_1_F1_in2 + node_1_F2_in2 + node_1_F3_in2 + node_1_F0_in2 >= 0,
    node_1_F1_inp + node_1_F2_inp + node_1_F3_inp + node_1_F0_inp <= 1,
    node_1_F1_inp + node_1_F2_inp + node_1_F3_inp + node_1_F0_inp >= 0,
    node_1_F0_in1 <= 1, node_1_F0_in1 >= 0,
    node_1_F1_in1 <= 1, node_1_F1_in1 >= 0,
    node_1_F2_in1 <= 1, node_1_F2_in1 >= 0,
    node_1_F3_in1 <= 1, node_1_F3_in1 >= 0,
    node_1_F0_in2 <= 1, node_1_F0_in2 >= 0,
    node_1_F1_in2 <= 1, node_1_F1_in2 >= 0,
    node_1_F2_in2 <= 1, node_1_F2_in2 >= 0,
    node_1_F3_in2 <= 1, node_1_F3_in2 >= 0,
    node_1_F0_inp <= 1, node_1_F0_inp >= 0,
    node_1_F1_inp <= 1, node_1_F1_inp >= 0,
    node_1_F2_inp <= 1, node_1_F2_inp >= 0,
    node_1_F3_inp <= 1, node_1_F3_inp >= 0
)

node_1_guarantees = And(
    node_1_F1_outp >= 0, node_1_F1_outp <= 1,
    node_1_F2_outp >= 0, node_1_F2_outp <= 1,
    node_1_F3_outp >= 0, node_1_F3_outp <= 1,
    node_1_F0_outp >= 0, node_1_F0_outp <= 1,
    node_1_F1_out1 == 0, node_1_F1_out2 == 0,
    node_1_F2_out1 == 0, node_1_F2_out2 == 0,
    node_1_F3_out1 == 0, node_1_F3_out2 == 0,
    node_1_F1_out1 + node_1_F2_out1 + node_1_F3_out1 + node_1_F0_out1 <= 1,
    node_1_F1_out1 + node_1_F2_out1 + node_1_F3_out1 + node_1_F0_out1 >= 0,
    node_1_F1_out2 + node_1_F2_out2 + node_1_F3_out2 + node_1_F0_out2 <= 1,
    node_1_F1_out2 + node_1_F2_out2 + node_1_F3_out2 + node_1_F0_out2 >= 0,
    node_1_F1_outp + node_1_F2_outp + node_1_F3_outp + node_1_F0_outp <= 1,
    node_1_F1_outp + node_1_F2_outp + node_1_F3_outp + node_1_F0_outp >= 0,
    node_1_F0_in1 + node_1_F0_in2 + node_1_F0_inp == 
        node_1_F0_out1 + node_1_F0_out2 + node_1_F0_outp,
    node_1_F1_in1 + node_1_F1_in2 + node_1_F1_inp == 
        node_1_F1_out1 + node_1_F1_out2 + node_1_F1_outp,
    node_1_F2_in1 + node_1_F2_in2 + node_1_F2_inp == 
        node_1_F2_out1 + node_1_F2_out2 + node_1_F2_outp,
    node_1_F3_in1 + node_1_F3_in2 + node_1_F3_inp == 
        node_1_F3_out1 + node_1_F3_out2 + node_1_F3_outp,
    node_1_F1_in1 + node_1_F2_in1 + node_1_F3_in1 + node_1_F0_in1 +
        node_1_F1_in2 + node_1_F2_in2 + node_1_F3_in2 + node_1_F0_in2 +
        node_1_F1_inp + node_1_F2_inp + node_1_F3_inp + node_1_F0_inp ==
        node_1_F1_out1 + node_1_F2_out1 + node_1_F3_out1 + node_1_F0_out1 +
        node_1_F1_out2 + node_1_F2_out2 + node_1_F3_out2 + node_1_F0_out2 +
        node_1_F1_outp + node_1_F2_outp + node_1_F3_outp + node_1_F0_outp
)
...
node_p_F1_in = node_1_F1_outp
node_p_F2_in = node_1_F2_outp
node_p_F3_in = node_1_F3_outp
node_p_F0_in = node_1_F0_outp

node_p_F1_out = node_1_F1_inp
node_p_F2_out = node_1_F2_inp
node_p_F3_out = node_1_F3_inp
node_p_F0_out = node_1_F0_inp

node_p_F1_sinked = Real('node_p_F1_sinked')
node_p_F2_sinked = Real('node_p_F2_sinked')
node_p_F3_sinked = Real('node_p_F3_sinked')

node_p_assumptions = And(
    node_p_F1_in + node_p_F2_in + node_p_F3_in + node_p_F0_in <= 1,
    node_p_F1_in + node_p_F2_in + node_p_F3_in + node_p_F0_in >= 0
)

node_p_guarantees = And(
    node_p_F0_in + node_p_F1_in + node_p_F2_in + node_p_F3_in ==
        node_p_F0_out + node_p_F1_out + node_p_F2_out + node_p_F3_out,
    node_p_F0_out == 
        node_p_F1_sinked + node_p_F2_sinked + node_p_F3_sinked 
        + node_p_F0_in,
    node_p_F0_out >= 0, node_p_F0_out <= 1,
    node_p_F1_out == 0, node_p_F2_out == 0, node_p_F3_out == 0,
    node_p_F1_sinked == node_p_F1_in,
    node_p_F2_sinked == node_p_F2_in,
    node_p_F3_sinked == node_p_F3_in
)
...
node_p_guarantees = Implies(node_p_assumptions, node_p_guarantees)
...
warehouse_guarantees = And(
    node_p_F3_sinked >= 0.2,
    node_p_F2_sinked >= 0.2,
    node_p_F1_sinked >= 0.2
)
